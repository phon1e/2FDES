...
mac_list = {'0': ['0xd6,0xc6,0x8f,0x74,0x7e,0xeb'],
            '1': ['0xfa,0x6c,0xb6,0x92,0x9c,0x39'],
...
#         print("Face Recognition Processing...")
        ...
        for encodeFace, faceLoc in zip(encodesCurFrame, faceCurFrame):
            ...
            mac_found = returnFunc(mySerialEsp2.runQ)
            ...
            if faceDis[matchIndex] < 0.50 and str(matchIndex) == mac_found:
                ...
                mySvModule.updateDb(url, pathDb,f'{f"user{matchIndex}"}/timeStamp/',str(matchIndex),s)
