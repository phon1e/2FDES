...
markedTimeList = []
mac_list = []
uKey_list = ["0","107109432922785666002", "118362548782737790824"]
...
#         print("Face Recognition Processing...")
        ...
        for encodeFace, faceLoc in zip(encodesCurFrame, faceCurFrame):
            ...
            if faceDis[matchIndex] < 0.50 and str(matchIndex) == mac_found:
                ...
                #mySvModule.updateDb(url, pathDb,f'{key}/{userKey}/timestamp/',f"record{matchIndex}",s)
                mySvModule.timestamp(userKey,matchIndex,s)
