            ...
            for q in qReturned:
                ...
                if(q!= ''):
                    ...
                    for encodeFace, faceLoc in zip(encodesCurFrame, faceCurFrame):
                        ...
                        #print(f"most similar {name}")
                        #print(f"faceDis {faceDis}")
                        #print(f"faces index {matchIndex} UID {uID}")
                        #end_time = time.time()
                        ...
                        valid_user = False
                        #print(f"facedis value : {faceDis}")
                        #print(f"current face {matchIndex}")
                        #print(f"userMac_around {userMac_around}")
                        if (faceDis[int(uID)] < 0.33):
